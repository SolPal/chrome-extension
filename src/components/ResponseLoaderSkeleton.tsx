...
export default function ResponseLoaderSkeleton({ ref }: { ref: React.MutableRefObject<any> }) {
    return (
        <div className="ml-2 flex w-full gap-2 items-center justify-start " ref={ref?.current}>
